...
Item {
    ...
    Kirigami.Badge {
        ...
        text: {
            ...
            if (unreadCount > 9999) {
                return i18ndc("plasma_applet_org.kde.plasma.taskmanager", "'k' is a suffix for 'thousand'; keep to one character or else the badge could overflow!", "9k+");
            } else if (unreadCount > 999) {
                let rounded = Math.floor(unreadCount / 1000);
                return i18ndc("plasma_applet_org.kde.plasma.taskmanager", "'k' is a suffix for 'thousand'; keep to one character or else the badge could overflow!", "%1k", rounded);
            } else {
