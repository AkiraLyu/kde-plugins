...
function preferredMinWidth() {
    ...
    if (!tasks.vertical && !tasks.iconsOnly) {
      ...
      if (tasks.plasmoid.configuration.taskMaxWidth === 3) { // custom
          return Math.min(width, tasks.plasmoid.configuration.customTaskMaxWidth);
      }
    }
...
function preferredMaxWidth() {
    ...
    if (tasks.plasmoid.configuration.taskMaxWidth === 3) { // custom
        return tasks.plasmoid.configuration.customTaskMaxWidth;
    }
