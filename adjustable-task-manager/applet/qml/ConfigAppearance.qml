...
KCMUtils.SimpleKCM {
    ...
    property alias cfg_customTaskMaxWidth: customTaskMaxWidth.value
    property alias cfg_shrinkTasksToTitle: shrinkTasksToTitle.checked
    property alias cfg_launcherSpacing: launcherSpacing.value
    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            ...
            model: [
                ...
                i18ndc("plasma_applet_org.kde.plasma.adjustabletaskmanager", "@item:inlistbox task width", "Custom")
            ]
        }

        QQC2.SpinBox {
            id: customTaskMaxWidth
            visible: !root.iconOnly && !root.plasmoidVertical && taskMaxWidth.currentIndex === 3
            Kirigami.FormData.label: i18ndc("plasma_applet_org.kde.plasma.adjustabletaskmanager", "@label:spinbox", "Maximum task width (px):")
            from: 1
            to: 4096
            editable: true
        }
        ...
        QQC2.CheckBox {
            id: shrinkTasksToTitle
            visible: customTaskMaxWidth.visible
            text: i18ndc("plasma_applet_org.kde.plasma.adjustabletaskmanager", "@option:check", "Fit task width to title")
        }

        QQC2.SpinBox {
            id: launcherSpacing
            visible: !root.iconOnly
            Kirigami.FormData.label: i18ndc("plasma_applet_org.kde.plasma.adjustabletaskmanager", "@label:spinbox", "Extra pinned icon spacing (px):")
            from: 0
            to: 256
            editable: true
        }
